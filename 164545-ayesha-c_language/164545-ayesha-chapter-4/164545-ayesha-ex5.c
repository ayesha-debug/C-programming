/*
 * this program is to add access to library functions like sin, exp, and pow.
 * Author: Sk.Ayesha
 * Created: 8 July, 2024
...
int top=0;
/** MAIN PROGRAM */
/** main: Accepts input for reverse polish calculator including sin exp and pow*/
...
/* End of main() */
/* To print data clearly to check it */
void printInstructions(void){
        ...
        printf(" - print in exponential :e\n");
        printf(" - print power  :p\n");
