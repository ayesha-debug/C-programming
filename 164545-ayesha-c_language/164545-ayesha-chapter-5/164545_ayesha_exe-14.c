/*
 * This program is to modify the sort program to handle a -r flag, which indicates sorting in reverse (decreasing) order. Be sure that -r works with -n. 
 * Author: Sk.Ayesha
 * Created: 1 Aug , 2024
 * Modified:1 Aug, 2024
 */
...
int main(int argc, char *argv[]) {
    ...
    if ((nlines = readlines(lineptr, MAXLINES)) >= 0) {
        q_sort((void**) lineptr, 0, nlines-1,
               (int (*)(void*, void*))(numeric ? (int (*)(void*, void*))numcmp : (int (*)(void*, void*))strcmp), reverse);
